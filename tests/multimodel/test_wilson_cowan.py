...
class TestWilsonCowanMass(MassTestCase):
    ...
    def test_init(self):
        ...
        self.assertDictEqual(wc_exc.parameters, DEFAULT_PARAMS_EXC)
        self.assertDictEqual(wc_inh.parameters, DEFAULT_PARAMS_INH)
...
class TestWilsonCowanNetworkNode(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertDictEqual(wc[0].parameters, DEFAULT_PARAMS_EXC)
        self.assertDictEqual(wc[1].parameters, DEFAULT_PARAMS_INH)
