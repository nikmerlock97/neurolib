...
class TestThalamicMass(MassTestCase):
    ...
    def test_init(self):
        ...
        self.assertDictEqual(tcr.parameters, DEFAULT_PARAMS_TCR)
        self.assertDictEqual(trn.parameters, DEFAULT_PARAMS_TRN)
        for thlm in [tcr, trn]:
...
class TestThalamicNetworkNode(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertDictEqual(thlm[0].parameters, DEFAULT_PARAMS_TCR)
        self.assertDictEqual(thlm[1].parameters, DEFAULT_PARAMS_TRN)
